...
public class firebasemessaging extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "ChatHN.com", "ChatHN.com.firebasemessaging");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "ChatHN.com.firebasemessaging", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
anywheresoftware.b4a.keywords.Common.LogImpl("53211265","Message arrived",0);
 //BA.debugLineNum = 33;BA.debugLine="Log($\"Message data: ${Message.GetData}\"$)";
anywheresoftware.b4a.keywords.Common.LogImpl("53211266",("Message data: "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_message.GetData().getObject()))+""),0);
 //BA.debugLineNum = 34;BA.debugLine="Dim n As Notification";
_n = new anywheresoftware.b4a.objects.NotificationWrapper();
 //BA.debugLineNum = 35;BA.debugLine="n.Initialize";
_n.Initialize();
 //BA.debugLineNum = 36;BA.debugLine="n.Icon = \"icon\"";
_n.setIcon("icon");
 //BA.debugLineNum = 37;BA.debugLine="n.SetInfo(Message.GetData.Get(\"title\"), Message.G";
_n.SetInfoNew(processBA,BA.ObjectToCharSequence(_message.GetData().Get((Object)("title"))),BA.ObjectToCharSequence(_message.GetData().Get((Object)("body"))),(Object)(mostCurrent._main.getObject()));
 //BA.debugLineNum = 38;BA.debugLine="n.Notify(1)";
_n.Notify((int) (1));
...
public ResumableSub_Service_Start(ChatHN.com.firebasemessaging parent,anywheresoftware.b4a.objects.IntentWrapper _startingintent) {
this.parent = parent;
this._startingintent = _startingintent;
}
ChatHN.com.firebasemessaging parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 24;BA.debugLine="If StartingIntent.IsInitialized Then";
if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 28;BA.debugLine="Service.StopAutomaticForeground 'remove if not us";
...
public static String  _subscribetotopics() throws Exception{
 //BA.debugLineNum = 14;BA.debugLine="Public Sub SubscribeToTopics";
 //BA.debugLineNum = 15;BA.debugLine="Try";
try { //BA.debugLineNum = 16;BA.debugLine="fm.SubscribeToTopic(Generales.Usuario) 'you c";
_fm.SubscribeToTopic(mostCurrent._generales._usuario /*String*/ );
 } 
       catch (Exception e4) {
			processBA.setLastException(e4); //BA.debugLineNum = 18;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("53080196",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(processBA)),0);
 };
